...
def parse_args():
    ...
    parser.add_argument(
        "--model_dir",
        default=os.environ.get("SM_CHANNEL_MODEL", "trained_models/latest.pth"),
    )
    parser.add_argument(
...
def main(args):
    ...
    ckpt_fpath = osp.join(args.model_dir)
    ...
    split_result = do_inference(
        model, ckpt_fpath, args.data_dir, args.input_size, args.batch_size
    )
    # ,split=split)
