...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image",
        default="../input/data/ICDAR17_Korean/images/img_1001.jpg",
        help="Load image file",
    )
    parser.add_argument(
        "--results", default="results", help="Folder for augmented image files"
    )
    parser.add_argument("--gray", action="store_true", help="Convert to grayscale 1st")
    parser.add_argument(
        "--seed", default=2022, type=int, help="Random number generator seed"
    )
